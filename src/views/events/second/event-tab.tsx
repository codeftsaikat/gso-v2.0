        ...
        <Tabs defaultValue="ongoing" value={activeTab} onValueChange={onTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-3 max-w-lg mx-auto">
                {eventCategories.map((category) => {
                    ...
                    return (
                        <TabsTrigger key={category.id} value={category.id} className="event-tab-item flex items-center cursor-pointer gap-2 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-white">
